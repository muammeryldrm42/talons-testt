...
export default definePlugin({
  name: "@open-talons/plugin-filesystem",
  version: "1.0.0",
  ...
  agents: [defineAgent({
    ...
    systemPrompt: "📁 Open Talons Filesystem Agent. Read, write, edit, list workspace files. Operations are sandboxed to the workspace directory. Writes require user permission.",
    allowedTools: ["read_file", "write_file", "list_directory", "edit_file", "delete_file", "search_files"],
  })],
});
