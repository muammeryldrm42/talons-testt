// ============================================================
// 🦅 @open-talons/core — MCP (Model Context Protocol) Client
...
export class MCPClient {
  ...
  async connect(): Promise<void> {
    ...
    await this.request("initialize", {
      ...
      capabilities: { tools: {} },
      clientInfo: { name: "open-talons", version: "2.4.0" },
    });
  ...
  /**
   * Get tool definitions from this MCP server, wrapped as Open Talons ToolDefinitions.
   */
