// ============================================================
// 🦅 @open-talons/telegram-bot
// Standalone Telegram bot that exposes Open Talons agents
// ============================================================
...
const talons = createTalons({
  ...
  .use(cryptoPlugin).use(securityPlugin).use(tradingPlugin)
...
function isAllowed(username: string | undefined, userId: number): boolean {
...
async function handleMessage(msg: any) {
  ...
  if (text.startsWith("/start")) {
    const greeting = `🦅 *Welcome to Open Talons Bot!*
...
console.log("🦅 Open Talons Telegram Bot starting...");
console.log(`   Provider: ${talons.getDefaultLLM().provider}`);
console.log(`   Plugins: ${talons.listPlugins().length}`);
console.log(`   Agents: ${talons.listAgents().length}`);
