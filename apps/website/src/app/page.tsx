    ...
    <main className="min-h-screen bg-bg text-white relative overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-bg/70 border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href="/plugins" className="hidden md:block text-sm text-gray-400 hover:text-white transition">📦 Plugins</a>
            <a href="/playground" className="hidden md:block text-sm text-gray-400 hover:text-white transition">📱 Telegram</a>
            <a href="#agents" className="hidden md:block text-sm text-gray-400 hover:text-white transition">Agents</a>
            <a href="/marketplace" className="hidden md:block text-sm text-gray-400 hover:text-white transition">Marketplace</a>
            <a href="#providers" className="hidden md:block text-sm text-gray-400 hover:text-white transition">LLMs</a>
            <a href="/chat" className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-accent/10 border border-accent/30 text-accent text-sm hover:bg-accent/20 transition"><span className="animate-pulse">●</span> Live Chat</a>
      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-24 pb-32 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <a href="/chat" className="flex items-center justify-center gap-2 px-8 py-4 rounded-lg bg-gradient-to-r from-accent to-accent2 text-white font-semibold hover:scale-105 transition"><Sparkles className="w-5 h-5" /> Try Live Chat</a>
          <a href="#quickstart"
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="/chat" className="flex items-center justify-center gap-2 px-8 py-4 rounded-lg bg-gradient-to-r from-accent to-accent2 text-white font-semibold hover:scale-105 transition"><Sparkles className="w-5 h-5" /> Try Live Chat</a>
          <a href="#quickstart" className="hover:text-white">Quick Start</a></li>
            </ul>
          </div>
          <div>
